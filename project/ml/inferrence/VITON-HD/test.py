...
def get_opt():
    ...
    parser.add_argument('--dataset_dir', type=str, default=r'C:\Users\singh\project\ml\inferrence\VITON-HD\datasets')
    parser.add_argument('--dataset_mode', type=str, default=r'test')
    parser.add_argument('--dataset_list', type=str, default=r'test_pairs.txt')
    parser.add_argument('--checkpoint_dir', type=str, default=r'C:\Users\singh\project\ml\inferrence\VITON-HD\checkpoints')
    parser.add_argument('--save_dir', type=str, default=r'C:\Users\singh\project\ml\inferrence\VITON-HD\results')
